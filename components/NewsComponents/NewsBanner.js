...
const HomeBanner = () => {
  ...
  const backgroundStyles = {
    ...
    backgroundImage: isMobile
      ? "url('/banner_images/news.jpg')"
      : "url('/banner_images/news.jpg')",
  };

  return (
    <Container fluid className='px-lg-5 p-0'>
      <Container fluid style={{ backgroundImage: 'url(/banner_images/news.jpg)', height: '90vh', backgroundSize: 'cover' }} className='d-lg-flex d-none'>
      </Container>
